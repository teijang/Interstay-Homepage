<%@ Page Title="" Language="C#" MasterPageFile="~/Master_EN.Master" AutoEventWireup="true" CodeBehind="Free-Trial.aspx.cs" Inherits="Interstay_Homepage.Free_Trial" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="container free_trial">
                <h5 class="text-center mb-5"> &lt;Please fill up the form below, then our sales manager will contact you via email&gt;</h5>
                
                <div class="input-group mb-3 row">
                    <div class="col-md-2 text-center">
                        <label for="lstType" class="control-label input-group-text">Type of Business</label>
                    </div>
                    <div class="col-md-4">
                        <asp:DropDownList ID="lstType" runat="server" CssClass="form-control" style="overflow:auto">
                            ...
                            <asp:ListItem Value="Resort">Resort</asp:ListItem>
                            <asp:ListItem Value="Etc">Etc</asp:ListItem>
                        </asp:DropDownList>
                    </div>
                    <div class="col-md-2 text-center">
                        <label for="lstCountry" class="control-label input-group-text">Country</label>
                    </div>
                    <div class="col-md-4">                                                
                ...
                <div class="input-group mb-3 row">
                    <div class="col-md-2 text-center">
                        <label for="lstType" class="control-label input-group-text">Company Name(Eng)</label>
                    </div>
                    <div class="col-md-4">
                        <asp:TextBox ID="txtCompanyNameEng" runat="server" class="form-control"></asp:TextBox>
                    </div>
                    <div class="col-md-2 text-center">
                        <label for="lstType" class="control-label input-group-text">Company Name(Local)</label>
                    </div>
                    <div class="col-md-4">
                ...
                <div class="input-group mb-3 row">
                    <div class="col-md-2 text-center">
                        <label for="lstType" class="control-label input-group-text"># of Rooms</label>
                    </div>
                    <div class="col-md-4">
                        <asp:TextBox ID="txtRooms" runat="server" class="form-control"></asp:TextBox>
                    </div>
                    <div class="col-md-2 text-center">
                        <label for="lstType" class="control-label input-group-text">Homepage</label>
                    </div>
                    <div class="col-md-4">
                ...
                <div class="input-group mb-3 row">
                    <div class="col-md-2 text-center">
                        <label for="lstType" class="control-label input-group-text">Contact Name</label>
                    </div>
                    <div class="col-md-4">
                        <asp:TextBox ID="txtContactName" runat="server" class="form-control"></asp:TextBox>
                    </div>
                    <div class="col-md-2 text-center">
                        <label for="lstType" class="control-label input-group-text">E-mail</label>
                    </div>
                    <div class="col-md-4">
                ...
                <div class="input-group mb-3 row">
                        <div class="col-md-2 text-center">
                            <label for="txtRooms" class="control-label input-group-text">Your Interests</label>
                        </div>
                        <div class="col-md-10">
                            <table style="width:100%">
                                <tbody>
                                    <tr>
                                        <td colspan="2"><strong>Please check all the features you are interested in:</strong></td>                                        
                                    </tr>
                                    <tr>
                                        <td>&nbsp;<asp:CheckBox ID="CheckBox0" runat="server" class="form-control" Text="Self Check-in/out" /></td>
                                        <td>&nbsp;<asp:CheckBox ID="CheckBox1" runat="server" class="form-control" Text="Instant Booking" /></td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;<asp:CheckBox ID="CheckBox2" runat="server" class="form-control" Text="Room Guides" /></td>
                                        <td>&nbsp;<asp:CheckBox ID="CheckBox3" runat="server" class="form-control" Text="Facility Guides" /></td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;<asp:CheckBox ID="CheckBox4" runat="server" class="form-control" Text="Request Housekeeping" /></td>
                                        <td>&nbsp;<asp:CheckBox ID="CheckBox5" runat="server" class="form-control" Text="Request Other Services" /></td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;<asp:CheckBox ID="CheckBox6" runat="server" class="form-control" Text="Room Service Order" /></td>
                                        <td>&nbsp;<asp:CheckBox ID="CheckBox7" runat="server" class="form-control" Text="Surrounding Info" /></td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;<asp:CheckBox ID="CheckBox8" runat="server" class="form-control" Text="Multi-language Support" /></td>
                                        <td>&nbsp;<asp:CheckBox ID="CheckBox9" runat="server" class="form-control" Text="Mobile Apps" /></td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
                                        <p>&nbsp;Anything Else:
                ...
                <div class="submit text-center mt-5">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Company Name is required." ControlToValidate="txtCompanyNameEng" Display="None"></asp:RequiredFieldValidator>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Contact Name is required." ControlToValidate="txtContactName" Display="None"></asp:RequiredFieldValidator>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Email address is required." ControlToValidate="txtContactEmail" Display="None"></asp:RequiredFieldValidator>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="# of Rooms is required." ControlToValidate="txtRooms" Display="None"></asp:RequiredFieldValidator>
                    <asp:RangeValidator ID="RangeValidator1" runat="server" ErrorMessage="# of Rooms value must be from 1 to 999." MaximumValue="999" MinimumValue="1" ControlToValidate="txtRooms" Display="None" ></asp:RangeValidator>
                    <asp:ValidationSummary ID="ValidationSummary1" runat="server" ShowSummary="true" DisplayMode="List" ForeColor="Red" />
                    <asp:Label ID="lblErrorMessage" runat="server" Text="" ForeColor="Red"></asp:Label>
                    <br />
                    <asp:Button ID="btnSubmit" runat="server" Text="Submit" class="btn btn-primary w-50" OnClick="btnSubmit_Click"/>                    
                </div>
            </div>
            </asp:Panel>
            <asp:Panel ID="Panel2" runat="server" Visible="false">
                <div class="container free_trial">
                    <h5 class="text-center mb-5">Thank you for submitting your information. We will contact you soon via email.</h5>
                </div>
            </asp:Panel>
</asp:Content>
